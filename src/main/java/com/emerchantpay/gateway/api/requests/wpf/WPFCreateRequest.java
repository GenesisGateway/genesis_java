...
public class WPFCreateRequest extends Request implements RiskParamsAttributes {
	...
	private WPFCreateAddressRequest billingAddress;
	private WPFCreateAddressRequest shippingAddress;
	...
	public WPFCreateAddressRequest billingAddress() {
		billingAddress = new WPFCreateAddressRequest(this, "billing_address");
		return billingAddress;
	}

	public WPFCreateAddressRequest shippingAddress() {
		shippingAddress = new WPFCreateAddressRequest(this, "shipping_address");
	...
	protected RequestBuilder buildRequest(String root) {
		...
		return new RequestBuilder(root).addElement("transaction_id", transactionId).addElement("usage", usage)
				...
				.addElement("shippingAddress", shippingAddress).addElement("transaction_types", transactionTypes)
	...
	public WPFCreateAddressRequest getBillingAddress() {
		return billingAddress;
	}
}
